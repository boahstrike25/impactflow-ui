...
function App() {
  ...
  (activeModule === key ? "bg-blue-200 font-semibold" : "hover:bg-blue-100")
}
              {key}
            </button>
          ))}
